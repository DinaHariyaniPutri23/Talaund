    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 bg-white rounded-2xl p-6 md:p-8 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100">
            ...
            <div class="space-y-6">
                ...
                <!-- 2. Jenis Pengiriman -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">2. Jenis Pengiriman</label>
                    <div class="relative">
                ...
                <!-- 3. Berat/Jumlah -->
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-2">3. Berat / Jumlah</label>
