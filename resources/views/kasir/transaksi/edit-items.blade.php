    ...
    <div class="bg-white rounded-2xl p-6 shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-gray-100">
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            ...
            <div class="flex flex-wrap gap-2">
                ...
                <a href="{{ route('dashboard.kasir.struk', $transaksi->id) }}" class="px-3 py-1.5 rounded-full text-xs font-semibold bg-blue-100 text-blue-700 hover:bg-blue-200 transition-colors">Lihat Struk</a>
            </div>
        </div>
    </div>
