...
<body class="flex h-screen overflow-hidden bg-mainBg text-textDark">
    ...
    <aside class="w-[260px] bg-sidebarBg text-white flex flex-col h-full shrink-0">
        ...
        <ul class="flex-1 px-[15px] py-[20px] list-none overflow-y-auto no-scrollbar">
            ...
            <li class="mb-[5px]">
                <a href="{{ route('dashboard.kasir.pelanggan') }}" class="flex items-center gap-[15px] py-[12px] px-[20px] text-white no-underline rounded-lg font-medium transition duration-300 {{ Request::routeIs('dashboard.kasir.pelanggan') ? 'bg-sidebarActive' : 'hover:bg-sidebarActive' }}">
