...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[20px] mb-[30px]">
        <div class="bg-cardBg rounded-[12px] p-[25px] flex items-start gap-[15px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[rgba(0,0,0,0.04)]">
            ...
            <div class="flex-1">
                ...
                <h4 class="text-[1.6rem] font-bold mb-[8px] text-[#10B981]">Rp 0</h4>
                <p class="text-[0.8rem] text-textMuted">- 0% dari bulan lalu</p>
            </div>
        </div>
        ...
        <div class="bg-cardBg rounded-[12px] p-[25px] flex items-start gap-[15px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[rgba(0,0,0,0.04)]">
            ...
            <div class="flex-1">
                ...
                <h4 class="text-[1.6rem] font-bold mb-[8px] text-[#3B82F6]">0</h4>
                <p class="text-[0.8rem] text-textMuted">- 0% dari bulan lalu</p>
            </div>
        </div>
        ...
        <div class="bg-cardBg rounded-[12px] p-[25px] flex items-start gap-[15px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[rgba(0,0,0,0.04)]">
            ...
            <div class="flex-1">
                ...
                <h4 class="text-[1.6rem] font-bold mb-[8px] text-[#8B5CF6]">0</h4>
                <p class="text-[0.8rem] text-textMuted">- 0% dari bulan lalu</p>
            </div>
        </div>
        ...
        <div class="bg-cardBg rounded-[12px] p-[25px] flex items-start gap-[15px] shadow-[0_2px_10px_rgba(0,0,0,0.02)] border border-[rgba(0,0,0,0.04)]">
            ...
            <div class="flex-1">
                ...
                <h4 class="text-[1.6rem] font-bold mb-[8px] text-[#EF4444]">Rp 0</h4>
                <p class="text-[0.8rem] text-textMuted">0 Transaksi Belum Lunas</p>
            </div>
        </div>
    </div>
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr>
                        ...
                        <th class="text-left p-[15px] text-[0.85rem] text-textDark font-semibold bg-[#F8FAFC] border-b border-borderColor">Layanan</th>
                        <th class="text-left p-[15px] text-[0.85rem] text-textDark font-semibold bg-[#F8FAFC] border-b border-borderColor">Berat</th>
                ...
                <tbody>
                    <tr>
                        <td colspan="6" class="text-center text-textMuted p-[30px] border-b border-borderColor">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        new Chart(ctx, {
            type: 'line',
            data: {
                labels: ['7 Apr', '12 Apr', '17 Apr', '22 Apr', '27 Apr', '2 Mei', '6 Mei'],
                datasets: [{
                    label: 'Omzet',
                    data: [0, 0, 0, 0, 0, 0, 0],
                    borderColor: '#3B82F6',
